			...
			<div class="container position-relative" style=" max-width: 1350px;">
				<div class="site-navigation text-center dark">
					...
					<ul class="js-clone-nav pl-0 d-none d-lg-inline-block site-menu">
						<li class=""><a href="/home" style="font-family: 'Jost';">HOME</a></li>
						<li class="has-children  headConcert">
							<a href="/concert">공연</a>
							<ul class="dropdown">
						...
						<li class="has-children headProduct">
						...
						<li class="has-children headHall">
						...
						<li class="headNotice"><a href="/notice/list">공지사항</a></li>
						...
						<c:choose>
							<c:when test="${mem_grade == 'B'}">		<!-- 일반 회원 -->
								...
								<a href="/cart" class="cart" onclick="cartbtn()">
										...
										<span id="mycartCnt" class="item-in-cart">
