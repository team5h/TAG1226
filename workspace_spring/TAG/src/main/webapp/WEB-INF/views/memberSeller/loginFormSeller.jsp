...
<h1> 판매자 로그인 </h1>
		...
		<form method="post" action="<c:url value='/loginS.do'/>" onsubmit="return logincheck()">
				  ...
				  <div class="textbox">
				  <input type="text" id="p_id" name="p_id" size="20" value="${cookie.id.value}" placeholder="아이디">
				  </div>
				  
				  <div class="textbox">
				  <input type="password" id="p_pw" name="p_pw" size="20" placeholder="비밀번호"> 
				  </div>
				...
				<div>
				<button id="joinBtn">
				<a onclick="location.href='/agreementS.do'">회원가입</a>
				</button>
				</div>
